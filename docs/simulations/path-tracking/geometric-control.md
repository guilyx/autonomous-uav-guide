...
```bash
python -m flybots.simulations.path_tracking.geometric_control
```
...
![Geometric SO(3)](https://media.githubusercontent.com/media/guilyx/flybots/main/src/flybots/simulations/path_tracking/geometric_control/geometric_control.gif)
