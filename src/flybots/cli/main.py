...
from flybots import __version__
from flybots.cli import catalogue
from flybots.cli.console import heading, style, table
...
def _cmd_envs(args: argparse.Namespace) -> int:
    from flybots.gym import list_envs, make
...
def _cmd_train(args: argparse.Namespace) -> int:
    from flybots.gym import evaluate, train
