...
:mod:`flybots.vehicles.components.allocation`.
...
from flybots.vehicles.components.allocation import ControlAllocation, Rotor, x_layout
from flybots.vehicles.components.motor import Motor
...
class MultirotorParams:
    ...
    Attributes:
        ...
        saturation: How the mixer resolves an infeasible thrust request,
            ...
            :class:`~flybots.vehicles.components.allocation.ControlAllocation`.
...
class Multirotor:
    ...
    :mod:`flybots.control` airframe-agnostic: only the mixer knows how many
    rotors there are.
    """
