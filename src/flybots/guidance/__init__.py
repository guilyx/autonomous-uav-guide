...
* :mod:`~flybots.guidance.fixed_wing_paths` — the geometry. Straight-line
  and orbit vector fields, stateless and pure.
* :mod:`~flybots.guidance.fixed_wing_mission` — the sequencing. Waypoint
  acceptance, racetracks, and return-to-launch, emitting
  :class:`~flybots.control.fixed_wing_autopilot.AutopilotCommand`.

Reference: R. W. Beard, T. W. McLain, *Small Unmanned Aircraft: Theory and
Practice*, Princeton University Press, 2012, Chapters 10-11.
"""

from flybots.guidance.fixed_wing_mission import (
    FixedWingMission,
    LineLeg,
    MissionDiagnostics,
    MissionLeg,
