...
in :mod:`~flybots.guidance.fixed_wing_paths`.
...
Wind
----
The airframe model in :mod:`flybots.vehicles.fixed_wing` has **no wind
...
from flybots.control.fixed_wing_autopilot import AutopilotCommand
...
from flybots.vehicles.fixed_wing.fixed_wing import FixedWingParams
...
class MissionLeg(ABC):
    ...
    :mod:`~flybots.guidance.fixed_wing_paths` and is stateless and pure;
...
def orbit_plan(
    ...
    *,
    ...
    Raises :class:`~flybots.guidance.fixed_wing_paths.GuidanceError` if the
...
class MissionDiagnostics:
    ...
    :attr:`~flybots.guidance.fixed_wing_paths.GuidanceOutput.path_error`."""
...
class FixedWingMission:
    ...
    --------
    >>> import numpy as np
    >>> from flybots.guidance import FixedWingMission, waypoint_plan
