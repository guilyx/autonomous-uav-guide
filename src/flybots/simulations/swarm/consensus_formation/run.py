...
from flybots.simulations.common import swarm_figure_8_ref
...
def main() -> None:
    ...
    logger = SimLogger("consensus_formation", out_dir=Path(__file__).parent)
    logger.log_metadata("algorithm", "Consensus Formation")
