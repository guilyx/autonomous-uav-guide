...
from flybots.control import StateManager
from flybots.control.state_machine import FlightMode
...
from flybots.simulations.common import CRUISE_ALT, WORLD_SIZE, frame_indices
...
def main() -> None:
    ...
    sm.arm()
    sm.run_takeoff(altitude=CRUISE_ALT, dt=0.005, timeout=12.0)
