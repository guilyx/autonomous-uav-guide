...
:class:`~uav_sim.control.fixed_wing_autopilot.FixedWingAutopilot`, the
...
:class:`~uav_sim.control.fixed_wing_autopilot.AutopilotGains`, evaluated at
...
class GuidanceGains:
    ...
    As with :class:`~uav_sim.control.fixed_wing_autopilot.AutopilotGains`,
    ...
    :class:`~uav_sim.control.fixed_wing_autopilot.FixedWingAutopilot`.
    """
...
class GuidanceOutput:
    ...
    :attr:`~uav_sim.control.fixed_wing_autopilot.AutopilotCommand.roll_feedforward`.
    """
...
class LinePath:
    ...
    --------
    >>> import numpy as np
    >>> from uav_sim.guidance.fixed_wing_paths import GuidanceGains, LinePath
