...
:class:`~uav_sim.vehicles.multirotor.multirotor.Multirotor`, and this module
...
from uav_sim.vehicles.components.allocation import Rotor
from uav_sim.vehicles.components.mixer import Mixer
from uav_sim.vehicles.multirotor.multirotor import Multirotor
...
class QuadrotorParams:
    ...
    coaxial stack — uses
    :class:`~uav_sim.vehicles.multirotor.multirotor.MultirotorParams`
    instead.
    """
