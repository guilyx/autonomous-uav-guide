...
from uav_sim.vehicles.fixed_wing.aerodynamics import aero_wrench
...
class TrimPoint:
    ...
    controls
        ...
        :meth:`~uav_sim.vehicles.fixed_wing.FixedWing.step`.
    body_velocity
...
def compute_trim(
    ...
    *,
    ...
    ----------
    params
        A :class:`~uav_sim.vehicles.fixed_wing.FixedWingParams`.
    airspeed
