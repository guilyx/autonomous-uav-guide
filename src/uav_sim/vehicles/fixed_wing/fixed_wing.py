...
The aerodynamics themselves live in :mod:`~uav_sim.vehicles.fixed_wing.
...
class FixedWingParams(UAVParams):
    ...
    def max_lift_coefficient(self) -> float:
        ...
        from uav_sim.vehicles.fixed_wing.aerodynamics import lift_coefficient
    ...
    * ``p, q, r`` — body angular rates [rad/s].
    ...
    def reset_trimmed(
        ...
        *,
        ...
        """
        from uav_sim.vehicles.fixed_wing.trim import compute_trim
